...
stands = [
    ...
    "SF_32.xlsx",
    "SF_41.xlsx",
    "SF_51.xlsx",  # Mottifile names in inputs folder
    "CF_22.xlsx",
    "CF_31.xlsx",
    "CF_32.xlsx",
    "CF_41.xlsx",
...
weather_inputs = [
    ...
    "SFw.csv",
    "SFw.csv",
    "SFw.csv",  # weather files in inputs folder
    "CFw.csv",
    "CFw.csv",
    "CFw.csv",
    "CFw.csv",
...
outnames = [
    ...
    "SF_32.nc",
    "SF_41.nc",
    "SF_51.nc",  # outputfiles to be written in outputs folder
    "CF_22.nc",
    "CF_31.nc",
    "CF_32.nc",
    "CF_41.nc",
...
humus = [
    ...
    7.0,
    5.5,
    5.2,  # Mor layer mass after 50 yrs spinoff, kg/m2
    6.7,
    5.6,
    6.7,
    5.3,
...
for stand, weather_input, outname, sitetype, hum in zip(
    stands, weather_inputs, outnames, sfcs, humus
):
    # ***************** local call for SUSI*****************************************************
    ...
    ageSim = {
        ...
        * np.ones(
            n
        ),  # age of stand when starting the simulation, yrs, nodewise along the strip
    ...
    forc = read_FMI_weather(
        ...
        start_date,
        end_date,
        sourcefile=str(CONFIG.paths.input_folder) + "/" + weather_input,
    )  # read weather input
