...
class Methane:
    ...
    def run_ch4_yr(self, yr, dfwt):
        ...
        return (
            ...
            CH4mean,
            CH4mean * 27.0,
        )  # convert to kg CO2-eq./ha/year, SGWP100 coefficient https://ghgprotocol.org/sites/default/files/2024-08/Global-Warming-Potential-Values%20%28August%202024%29.pdf
