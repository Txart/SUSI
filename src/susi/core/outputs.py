...
class Outputs:
    ...
    def initialize_scens(self):
        ...
        ditch_depths_east = self.ncf.createVariable(
            "/scen/ditch_depths_east", "f4", ("nscens",)
        )
        ditch_depths_east.units = "east ditch depth in meters, negative downwards"
        ditch_depths_west = self.ncf.createVariable(
            "/scen/ditch_depths_west", "f4", ("nscens",)
        )
    ...
    def initialize_paras(self):
        ...
        sfc.units = (
            "site fertility class, integer 2 ruohoturvekangas .... 6 jäkäläturvekangas"
        )
        tree_species_dominant = self.ncf.createVariable(
            "/scen/tree_species_dominant", "f4", ("ncols",)
        )
        tree_species_dominant.units = (
            "tree species, 1 Scots pine, 2 Norway spruce, from Motti"
        )
        tree_species_subdominant = self.ncf.createVariable(
            "/scen/tree_species_subdominant", "f4", ("ncols",)
        )
        tree_species_subdominant.units = (
            "tree species, 1 Scots pine, 2 Norway spruce, from Motti"
        )
        tree_species_under = self.ncf.createVariable(
            "/scen/tree_species_under", "f4", ("ncols",)
        )
        tree_species_under.units = (
            "tree species, 1 Scots pine, 2 Norway spruce, from Motti"
        )
    ...
    def initialize_stand(self):
        ...
        biomass = self.ncf.createVariable(
            "/stand/biomass",
            "f4",
            (
                "nscens",
        ...
        n_demand = self.ncf.createVariable(
            "/stand/n_demand",
            "f4",
            (
                "nscens",
        ...
        p_demand = self.ncf.createVariable(
            "/stand/p_demand",
            "f4",
            (
                "nscens",
        ...
        k_demand = self.ncf.createVariable(
            "/stand/k_demand",
            "f4",
            (
                "nscens",
        ...
        leafarea = self.ncf.createVariable(
            "/stand/leafarea",
            "f4",
            (
                "nscens",
        ...
        )  # one sided leaf area m2 m-2
        leafarea.units = "stand one-sided leaf area [m2/m2]"
        leafmass = self.ncf.createVariable(
            "/stand/leafmass",
            "f4",
            (
                "nscens",
        ...
        )  # leaf dry biomass kg/ha
        leafmass.units = "stand total leaf mass [kg/ha]"
        logvolume = self.ncf.createVariable(
            "/stand/logvolume",
            "f4",
            (
                "nscens",
        ...
        )  # saw log volume m3/ha
        logvolume.units = "stand volume of sawlogs [m3/ha]"
        finerootlitter = self.ncf.createVariable(
            "/stand/finerootlitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        )  # fine root litter kg/ha/yr
        finerootlitter.units = "stand fine root litterfall in dry biomass [kg/ha/yr] "
        n_finerootlitter = self.ncf.createVariable(
            "/stand/n_finerootlitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        p_finerootlitter = self.ncf.createVariable(
            "/stand/p_finerootlitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        k_finerootlitter = self.ncf.createVariable(
            "/stand/k_finerootlitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        nonwoodylitter = self.ncf.createVariable(
        ...
        nonwoodylitter.units = (
            "stand non-woody litterfall: leaves + fineroots [kg/ha/yr]"
        )
        n_nonwoodylitter = self.ncf.createVariable(
        ...
        n_nonwoodylitter.units = (
            "N in stand non-woody litterfall: leaves + fineroots [kg/ha/yr]"
        )
        p_nonwoodylitter = self.ncf.createVariable(
        ...
        p_nonwoodylitter.units = (
            "P in stand non-woody litterfall: leaves + fineroots [kg/ha/yr]"
        )
        k_nonwoodylitter = self.ncf.createVariable(
        ...
        k_nonwoodylitter.units = (
            "K in stand non-woody litterfall: leaves + fineroots [kg/ha/yr]"
        )

        woody_litter_mort = self.ncf.createVariable(
        ...
        woody_litter_mort.units = (
            "stand woody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )
        n_woody_litter_mort = self.ncf.createVariable(
        ...
        n_woody_litter_mort.units = (
            "N in stand woody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )
        p_woody_litter_mort = self.ncf.createVariable(
        ...
        p_woody_litter_mort.units = (
            "P in stand woody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )
        k_woody_litter_mort = self.ncf.createVariable(
        ...
        k_woody_litter_mort.units = (
            "K in stand woody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )

        non_woody_litter_mort = self.ncf.createVariable(
        ...
        non_woody_litter_mort.units = (
            "stand nonwoody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )
        n_non_woody_litter_mort = self.ncf.createVariable(
        ...
        n_non_woody_litter_mort.units = (
            "N in stand nonwoody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )
        p_non_woody_litter_mort = self.ncf.createVariable(
        ...
        p_non_woody_litter_mort.units = (
            "P in stand nonwoody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )
        k_non_woody_litter_mort = self.ncf.createVariable(
        ...
        k_non_woody_litter_mort.units = (
            "K in stand nonwoody litterfall from dead trees in dry biomass [kg/ha/yr] "
        )

        woody_lresid = self.ncf.createVariable(
            "/stand/woody_lresid",
            "f4",
            (
                "nscens",
        ...
        n_woody_lresid = self.ncf.createVariable(
        ...
        p_woody_lresid = self.ncf.createVariable(
        ...
        k_woody_lresid = self.ncf.createVariable(
        ...
        nonwoody_lresid = self.ncf.createVariable(
        ...
        n_nonwoody_lresid = self.ncf.createVariable(
        ...
        n_nonwoody_lresid.units = (
            "N in nonwoody logging residue mass at stand scale [kg/ha]"
        )
        p_nonwoody_lresid = self.ncf.createVariable(
        ...
        p_nonwoody_lresid.units = (
            "P in nonwoody logging residue mass at stand scale [kg/ha]"
        )
        k_nonwoody_lresid = self.ncf.createVariable(
        ...
        k_nonwoody_lresid.units = (
            "K in nonwoody logging residue mass at stand scale [kg/ha]"
        )

        pulpvolume = self.ncf.createVariable(
            "/stand/pulpvolume",
            "f4",
            (
                "nscens",
        ...
        )  # pulpwood volume m3/ha
        pulpvolume.units = "stand pulpwood volume [m3/ha]"
        stems = self.ncf.createVariable(
            "/stand/stems",
            "f4",
            (
                "nscens",
        ...
        )  # stocking, number of stems pcs/ha
        stems.units = "stocking, number of stems [pcs/ha]"
        volume = self.ncf.createVariable(
            "/stand/volume",
            "f4",
            (
                "nscens",
        ...
        volumegrowth = self.ncf.createVariable(
            "/stand/volumegrowth",
            "f4",
            (
                "nscens",
        ...
        woodylitter = self.ncf.createVariable(
            "/stand/woodylitter",
            "f4",
            (
                "nscens",
        ...
        n_woodylitter = self.ncf.createVariable(
            "/stand/n_woodylitter",
            "f4",
            (
                "nscens",
        ...
        p_woodylitter = self.ncf.createVariable(
            "/stand/p_woodylitter",
            "f4",
            (
                "nscens",
        ...
        k_woodylitter = self.ncf.createVariable(
            "/stand/k_woodylitter",
            "f4",
            (
                "nscens",
        ...
        )  # yield. here same as volume
        yi.units = "cumulative volume of growing stock, here same as volume [m3/ha] "
        previous_nut_stat = self.ncf.createVariable(
            "/stand/previous_nut_stat",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        nut_stat = self.ncf.createVariable(
            "/stand/nut_stat",
            "f4",
            (
                "nscens",
    ...
    def initialize_canopy_layer(self, name):
        ...
        finerootlitter.units = (
            "canopy layer fine root litterfall in dry biomass [kg/tree/yr] "
        )
        n_finerootlitter = self.ncf.createVariable(
            "/stand/" + name + "/n_finerootlitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        nonwoodylitter.units = (
            "canopy layer non-woody litterfall: leaves + fineroots [kg/tree/yr]"
        )
        n_nonwoodylitter = self.ncf.createVariable(
            "/stand/" + name + "/n_nonwoodylitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        n_nonwoodylitter.units = (
            "N in canopy layer non-woody litterfall: leaves + fineroots [kg/tree/yr]"
        )
        p_nonwoodylitter = self.ncf.createVariable(
            "/stand/" + name + "/p_nonwoodylitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        p_nonwoodylitter.units = (
            "P in canopy layer non-woody litterfall: leaves + fineroots [kg/tree/yr]"
        )
        k_nonwoodylitter = self.ncf.createVariable(
            "/stand/" + name + "/k_nonwoodylitter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        k_nonwoodylitter.units = (
            "K in canopy layer non-woody litterfall: leaves + fineroots [kg/tree/yr]"
        )

        pulpvolume = self.ncf.createVariable(
            "/stand/" + name + "/pulpvolume",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        n_nonwoody_lresid.units = (
            "N in canopy layer nonwoody logging residues [kg/tree/yr]"
        )
        p_nonwoody_lresid = self.ncf.createVariable(
            "/stand/" + name + "/p_nonwoody_lresid",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        p_nonwoody_lresid.units = (
            "P in canopy layer nonwoody logging residues [kg/tree/yr]"
        )
        k_nonwoody_lresid = self.ncf.createVariable(
            "/stand/" + name + "/k_nonwoody_lresid",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        k_nonwoody_lresid.units = (
            "K in canopy layer nonwoody logging residues [kg/tree/yr]"
        )

        woody_lresid = self.ncf.createVariable(
            "/stand/" + name + "/woody_lresid",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        non_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/non_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        n_non_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/n_non_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        p_non_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/p_non_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        k_non_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/k_non_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        n_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/n_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        p_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/p_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        k_woody_litter_mort = self.ncf.createVariable(
            "/stand/" + name + "/k_woody_litter_mort",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        new_lmass = self.ncf.createVariable(
            "/stand/" + name + "/new_lmass",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        leaf_litter = self.ncf.createVariable(
            "/stand/" + name + "/leaf_litter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        leaf_litter.units = (
            "leaf litterfall in the canopy layer, dry biomass  [kg/tree/yr]"
        )
        C_consumption = self.ncf.createVariable(
            "/stand/" + name + "/C_consumption",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        leafmax = self.ncf.createVariable(
            "/stand/" + name + "/leafmax",
            "f4",
            (
                "nscens",
        ...
        leafmin = self.ncf.createVariable(
            "/stand/" + name + "/leafmin",
            "f4",
            (
                "nscens",
        ...
        NPP_pot = self.ncf.createVariable(
            "/stand/" + name + "/NPP_pot",
            "f4",
            (
                "nscens",
        ...
        Nleafdemand = self.ncf.createVariable(
            "/stand/" + name + "/Nleafdemand",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        Nleaf_litter = self.ncf.createVariable(
            "/stand/" + name + "/Nleaf_litter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        Pleafdemand = self.ncf.createVariable(
            "/stand/" + name + "/Pleafdemand",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        Pleaf_litter = self.ncf.createVariable(
            "/stand/" + name + "/Pleaf_litter",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        Kleafdemand = self.ncf.createVariable(
            "/stand/" + name + "/Kleafdemand",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        Kleaf_litter = self.ncf.createVariable(
            "/stand/" + name + "/Kleaf_litter",
            "f4",
            (
                "nscens",
                "nyrs",
    ...
    def initialize_gv(self):
        ...
        gv_field = self.ncf.createVariable(
            "/groundvegetation/gv_field",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        gv_bot = self.ncf.createVariable(
            "/groundvegetation/gv_bot",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        gv_leafmass = self.ncf.createVariable(
            "/groundvegetation/gv_leafmass",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        ds_litterfall = self.ncf.createVariable(
            "/groundvegetation/ds_litterfall",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        h_litterfall = self.ncf.createVariable(
            "/groundvegetation/h_litterfall",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        s_litterfall = self.ncf.createVariable(
            "/groundvegetation/s_litterfall",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        n_litter_nw = self.ncf.createVariable(
        ...
        p_litter_nw = self.ncf.createVariable(
        ...
        k_litter_nw = self.ncf.createVariable(
        ...
        n_litter_w = self.ncf.createVariable(
        ...
        p_litter_w = self.ncf.createVariable(
        ...
        k_litter_w = self.ncf.createVariable(
        ...
        n_gv = self.ncf.createVariable(
            "/groundvegetation/n_gv",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        p_gv = self.ncf.createVariable(
            "/groundvegetation/p_gv",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        k_gv = self.ncf.createVariable(
            "/groundvegetation/k_gv",
            "f4",
            (
                "nscens",
                "nyrs",
    ...
    def initialize_esom(self, substance):
        ...
        out_root_lyr = self.ncf.createVariable(
            "/esom/" + substance + "/out_root_lyr",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        out_below_root_lyr = self.ncf.createVariable(
            "/esom/" + substance + "/out_below_root_lyr",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        out_below_root_lyr.units = (
            "annual output of substance below the root layer [kg/ha/yr]"
        )

        if substance == "Mass":
            c_to_atm = self.ncf.createVariable(
                "/esom/" + substance + "/c_to_atm",
                "f4",
                (
                    "nscens",
                    "nyrs",
            ...
            lmwdoc = self.ncf.createVariable(
                "/esom/" + substance + "/lmwdoc",
                "f4",
                (
                    "nscens",
                    "nyrs",
    ...
    def initialize_cpy(self):
        ...
        interc_yr = self.ncf.createVariable(
            "/cpy/interc_yr",
            "f4",
            (
                "nscens",
        ...
        transpi = self.ncf.createVariable(
            "/cpy/transpi",
            "f4",
            (
                "nscens",
        ...
        transpi_yr = self.ncf.createVariable(
            "/cpy/transpi_yr",
            "f4",
            (
                "nscens",
        ...
        efloor = self.ncf.createVariable(
            "/cpy/efloor",
            "f4",
            (
                "nscens",
        ...
        efloor_yr = self.ncf.createVariable(
            "/cpy/efloor_yr",
            "f4",
            (
                "nscens",
        ...
        SWEmax = self.ncf.createVariable(
            "/cpy/SWEmax",
            "f4",
            (
                "nscens",
    ...
    def initialize_strip(self, strip):
        ...
        dwtyr_growingseason = self.ncf.createVariable(
            "/strip/dwtyr_growingseason",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        dwtyr_latesummer = self.ncf.createVariable(
            "/strip/dwtyr_latesummer",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        deltas = self.ncf.createVariable(
            "/strip/deltas",
            "f4",
            (
                "nscens",
        ...
        roff.units = (
            "total runoff including west and east ditches and surface runoff [m/day]"
        )
        roffwest = self.ncf.createVariable(
            "/strip/roffwest",
            "f4",
            (
                "nscens",
        ...
        roffeast = self.ncf.createVariable(
            "/strip/roffeast",
            "f4",
            (
                "nscens",
        ...
        surfacerunoff = self.ncf.createVariable(
            "/strip/surfacerunoff",
            "f4",
            (
                "nscens",
        ...
        residencetime = self.ncf.createVariable(
            "/strip/residencetime",
            "f4",
            (
                "nscens",
        ...
        ixwest = self.ncf.createVariable(
            "/strip/ixwest",
            "f4",
            (
                "nscens",
        ...
        ixwest.units = (
            "columns discharging to the west ditch, [index number of a column]"
        )
        ixeast = self.ncf.createVariable(
            "/strip/ixeast",
            "f4",
            (
                "nscens",
    ...
    def initialize_methane(self):
        ...
        ch4_in_co2 = self.ncf.createVariable(
            "/methane/ch4_in_co2",
            "f4",
            (
                "nscens",
    ...
    def initialize_fertilization(self):
        ...
        fp = self.ncf.createVariable(
            "/fertilization/p_release",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        fk = self.ncf.createVariable(
            "/fertilization/k_release",
            "f4",
            (
                "nscens",
                "nyrs",
    ...
    def initialize_export(self):
        ...
        hmwtoditch.units = (
            "hmwdoc reaching the ditch, reduced by the biodegradation [kg/ha/yr]"
        )
        lmwtoditch = self.ncf.createVariable(
            "/export/lmwtoditch",
            "f4",
            (
                "nscens",
        ...
        lmwtoditch.units = (
            "lmwdoc reaching the ditch, reduced by the biodegradation [kg/ha/yr]"
        )

        hmwdoc_to_west = self.ncf.createVariable(
            "/export/hmwdoc_to_west",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        hmwdoc_to_west.units = (
            "HMW doc export from a column reaching the west ditch [kg/ha/yr]"
        )
        hmwdoc_to_east = self.ncf.createVariable(
            "/export/hmwdoc_to_east",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        hmwdoc_to_east.units = (
            "HMW doc export from a column reaching the east ditch [kg/ha/yr]"
        )

        lmwdoc_to_west = self.ncf.createVariable(
            "/export/lmwdoc_to_west",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        lmwdoc_to_west.units = (
            "LMW doc export from a column reaching the west ditch [kg/ha/yr]"
        )
        lmwdoc_to_east = self.ncf.createVariable(
            "/export/lmwdoc_to_east",
            "f4",
            (
                "nscens",
                "nyrs",
    ...
    def initialize_nutrient_balance(self, substance):
        ...
        decomposition_root_lyr = self.ncf.createVariable(
            "/balance/" + substance + "/decomposition_root_lyr",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        decomposition_below_root_lyr = self.ncf.createVariable(
            "/balance/" + substance + "/decomposition_below_root_lyr",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        deposition = self.ncf.createVariable(
            "/balance/" + substance + "/deposition",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        fertilization_release = self.ncf.createVariable(
            "/balance/" + substance + "/fertilization_release",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        stand_demand = self.ncf.createVariable(
            "/balance/" + substance + "/stand_demand",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        gv_demand = self.ncf.createVariable(
            "/balance/" + substance + "/gv_demand",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        balance_root_lyr = self.ncf.createVariable(
            "/balance/" + substance + "/balance_root_lyr",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        balance_root_lyr.units = (
            "nutrient balance in root layer supply minus demand [kg/ha/yr]"
        )

        to_water = self.ncf.createVariable(
            "/balance/" + substance + "/to_water",
            "f4",
            (
                "nscens",
                "nyrs",
    ...
    def initialize_carbon_balance(self):
        ...
        gv_litter_in = self.ncf.createVariable(
            "/balance/C/gv_litter_in",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        stand_change = self.ncf.createVariable(
            "/balance/C/stand_change",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        gv_change = self.ncf.createVariable(
            "/balance/C/gv_change",
            "f4",
            (
                "nscens",
        ...
        co2c_release = self.ncf.createVariable(
            "/balance/C/co2c_release",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        ch4c_release = self.ncf.createVariable(
            "/balance/C/ch4c_release",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        LMWdoc_to_water = self.ncf.createVariable(
            "/balance/C/LMWdoc_to_water",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        HMWdoc_to_atm = self.ncf.createVariable(
            "/balance/C/LMWdoc_to_atm",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        HMW_to_water = self.ncf.createVariable(
            "/balance/C/HMW_to_water",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        HMW_to_atm = self.ncf.createVariable(
            "/balance/C/HMW_to_atm",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        stand_c_balance_c = self.ncf.createVariable(
            "/balance/C/stand_c_balance_c",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        soil_c_balance_c = self.ncf.createVariable(
            "/balance/C/soil_c_balance_c",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        stand_c_balance_co2eq = self.ncf.createVariable(
            "/balance/C/stand_c_balance_co2eq",
            "f4",
            (
                "nscens",
                "nyrs",
        ...
        soil_c_balance_co2eq = self.ncf.createVariable(
    ...
    def initialize_ojanen(self):
        ...
        soil_co2_balance = self.ncf.createVariable(
            "/ojanen/soil_co2_balance",
            "f4",
            (
                "nscens",
                "nyrs",
    ...
    def write_scen(self, scen, ditch_depth_west, ditch_depth_east):
        self.ncf["scen"]["ditch_depths_mean"][scen] = (
            ditch_depth_east + ditch_depth_west
        ) / 2.0
    ...
    def write_strip(self, scen, start, days, yr, year, dfwt, stpout, outpara, stp):
        ...
        self.ncf["strip"]["roff"][scen, start : start + days] = stpout["runoff"][
            scen, start : start + days
        ]
        self.ncf["strip"]["roffwest"][scen, start : start + days] = stpout[
            "runoffwest"
        ][scen, start : start + days]
        self.ncf["strip"]["roffeast"][scen, start : start + days] = stpout[
            "runoffeast"
        ][scen, start : start + days]
        self.ncf["strip"]["surfacerunoff"][scen, start : start + days] = stpout[
            "surfacerunoff"
        ][scen, start : start + days, :]
